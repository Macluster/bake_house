...
mysqli_query($con,"insert into orders(cakeId,bakerId,userId,weight,calories,eggless,sugarfree,candleId,writing,date,time) values('$cakeId','$bakerId','$userId',$weight,'$calories','$eggless','$sugarfree','$candleId','$writing','$date','$time')");
echo "success";
